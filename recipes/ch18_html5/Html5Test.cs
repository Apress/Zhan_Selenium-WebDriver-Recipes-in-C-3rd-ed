...
namespace SeleniumRecipes {
    ...
    public class Ch18Html5Test {
        ...
        public void TestFakeGeolocationWithJavaScript() {
            ...
            Double latitude = -33.8571197;
            Double longitude = 151.2138464;
            ((IJavaScriptExecutor) driver).ExecuteScript("window.navigator.geolocation.getCurrentPosition=function(success){; var position = {'coords' : {'latitude': '" + latitude + "','longitude': '" + longitude + "'}}; success(position);}");

            driver.FindElement(By.Id("get-current-location-link")).Click();
            System.Threading.Thread.Sleep(2500); // wait for location to populate
