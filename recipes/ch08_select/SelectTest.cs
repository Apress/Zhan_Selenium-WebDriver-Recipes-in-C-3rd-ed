...
namespace SeleniumRecipes
{
    ...
    public class Ch08SelectTest
    {
        ...
        public void TestSelectOptionBySendKeys()
        {
            ...
            System.Threading.Thread.Sleep(500); // important, needs to add some waiting here
        ...
        {
            var selectElem = driver.FindElement(By.Id("car_make_select"));
            IList<String> selectLabels = new List<String>();
            IList<String> selectValues = new List<String>();

            foreach (var option in selectElem.FindElements(By.TagName("option")))
            {
        ...
        var select = new SelectElement(driver.FindElement(By.Id("car_make_select")));
        select.SelectByText("Volvo (Sweden)");
